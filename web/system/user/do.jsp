	...
	if(sessionuser != null)
	{
		...
		else if(mode.equals("2"))
		{
			...
			try
			{
				connection = DataSource.connection(SystemProperty.DATASOURCE);	
				DataSource datasource = new DataSource(connection);	
				datasource.execute("INSERT INTO T_USER(ID, NAME, CODE, LOGINNAME, PASSWORD, ROLE, CREATE_DATE) VALUES(?, ?, ?, ?, ?, ?, CURRENT_TIMESTAMP)", SystemUtils.uuid(), name, code, loginname, password);
				connection.commit();
			}
			catch(Exception e)
			{
